...
public class Moooo extends Application {
	...
	private static String Bild = "http://www.mariowiki.com/images/thumb/3/3f/SuperMushroom.png/50px-SuperMushroom.png";
	...
	private void moveHeldTo(double x, double y) {
		...
		if (x - cx >= 0 && x + cx <= H) {
			Held.relocate(x - cx, Held.getLayoutY());
		}
		if (y - cy >= 0 && y + cy <= B) {
			Held.relocate(Held.getLayoutX(), y - cy);
		}
	}
